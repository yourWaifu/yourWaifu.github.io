...
<iframe width="100%" height="315" src="https://www.youtube.com/embed/uQt9vWHvJQ4?si=1zxkC1gV1pMbLl-c" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullscreen></iframe>
Video version of this article

![](/images/my-game-engine/1_vFHk5QtyZg5VjN5PZIU77g.webp)
Blender Classroom
...
![](/images/my-game-engine/1_XJsCLjkRO3U8WIZJFG5dIA.webp)
[google/filament: Filament is a real-time physically based rendering engine for Android, iOS, Windows, Linux, macOS, and WebGL2 (github.com)](https://github.com/google/filament)
...
![](/images/my-game-engine/1_sf-i-RxlboRj6dE0AMDEZQ.webp)
...
![](/images/my-game-engine/1_nZewzv5zR-UV_K7beZCU5Q.webp)
...
![](/images/my-game-engine/1_0ZEryLF6Tj4ozbOHmWG49w.webp)
...
![image of walls](/images/my-game-engine/1_qPvde-V3pp2vrCKobZKmCw.webp)

Now, I needed to prevent players from going through walls and objects.

![](/images/my-game-engine/1_MMmMND9lMJKE-FrFw_xLRg.webp)
...
![](/images/my-game-engine/1_GBK_udIM3P5zCj_GZc00DA.webp)
...
![](/images/my-game-engine/1_A5gmlXiovO9Yn4FMqSyDRQ.webp)
[React — A JavaScript library for building user interfaces (reactjs.org), ESLint — Pluggable JavaScript linter, Frequent ‘javascript’ Questions — Stack Overflow](https://reactjs.org/)
...
![](/images/my-game-engine/1_wBbI3vsIjQyn0Fk3LneWxQ.webp)
...
![](/images/my-game-engine/1_GbfNCNlaJwoG5TvqXD5vEA.webp)
...
![](/images/my-game-engine/1_hOHy_Ct4SFjb9_D6uA9-Cw.webp)
...
![Sun typed in the game’s console](/images/my-game-engine/1_IiFv7z92yGoSYRMiWw9VpQ.webp)

Alright, time for some demos. So, the first thing I’m going to show is about the sun.

![In the game's console, "sun" is entered, sun is an object with two functions that are written with native code. set intensity and set direction](/images/my-game-engine/1_2b72BxoHhGvLPvLc8SRKhw.webp)
...
![In the game's console, "sun.setIntensity(500)" is entered. In the game, the lighting from the sun becomes very dim](/images/my-game-engine/1_ESl3_xmmcGvROOkwuIlAkQ.webp)
...
![writing a script in the game's console](/images/my-game-engine/1_ERPGWepuOMIcQdyOvXALVw.webp)
...
![](/images/my-game-engine/1_-WvTAnIQfIk_C7D8pFGVKA.webp)
[facebook/hermes: A JavaScript engine optimized for running React Native. (github.com)](https://github.com/facebook/hermes)
